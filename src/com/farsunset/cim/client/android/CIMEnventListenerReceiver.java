...
import com.farsunset.nio.mutual.Message;
...
public  abstract  class CIMEnventListenerReceiver extends BroadcastReceiver implements OnCIMMessageListener {
	...
	private void filterType999Message(com.farsunset.nio.mutual.Message message)
	{
	...
	@Override
	public abstract void onMessageReceived(com.farsunset.nio.mutual.Message message);
	@Override
